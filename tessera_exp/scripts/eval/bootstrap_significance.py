#!/usr/bin/env python3
"""Paired bootstrap significance test for TESSERA-RAG vs baselines."""
import json
import sys
...
def main():
    ...
    methods_to_compare = [
        ("dense_concat", "tessera_rag", "TESSERA-RAG vs Dense-Concat"),
        ("dense_concat", "ablation_no_redundancy_e2e", "w/o Redundancy vs Dense-Concat"),
        ("tessera_rag", "ablation_no_redundancy_e2e", "TESSERA-RAG vs w/o Redundancy"),
        ("tessera_rag", "ablation_no_pathmaxsim_e2e", "TESSERA-RAG vs w/o PathMaxSim"),
    ]

    # Load all predictions
    all_preds = {}
    for method in ["dense_concat", "tessera_rag", "ablation_no_redundancy_e2e", "ablation_no_pathmaxsim_e2e"]:
