...
def main() -> int:
    ...
    parser.add_argument(
        "--router-split-dir",
        type=Path,
        default=Path("/home/yongqi.yin/reaserch_paper/tessera_exp/runs/router_deberta_full_v1_router_deberta/router_data"),
    )
    parser.add_argument(
        "--table1c-metrics",
        type=Path,
        default=Path(
            "/home/yongqi.yin/reaserch_paper/tessera_exp/artifacts/results/"
