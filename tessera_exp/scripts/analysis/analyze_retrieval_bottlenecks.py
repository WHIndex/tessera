...
def analyze(rows: list[dict[str, Any]], method: str, ks: list[int]) -> dict[str, Any]:
    ...
    for row in rows:
        ...
        cand_any = _trace_value(trace, "tessera_v9_candidate_pool_any_hit", default=-1.0)
        cand_hits = _trace_value(trace, "tessera_v9_candidate_pool_hits", default=0.0)
        cand_cov = _trace_value(trace, "tessera_v9_candidate_pool_rel_coverage", default=0.0)
        if cand_any >= 0:
            pool_any.append(cand_any)
        pool_hits.append(cand_hits)
        pool_cov.append(cand_cov)
        dense_added.append(_trace_value(trace, "tessera_v9_dense_added"))
        sparse_added.append(_trace_value(trace, "tessera_v9_sparse_added"))
        graph_added.append(_trace_value(trace, "tessera_v9_graph_added"))
        local_changed.append(_trace_value(trace, "tessera_v9_local_changed_count"))
        local_slot_cov.append(_trace_value(trace, "tessera_v9_local_slot_coverage"))
