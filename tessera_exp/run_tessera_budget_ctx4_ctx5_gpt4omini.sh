...
PYTHON_BIN="${PYTHON_BIN:-/home/wanghui/rag/multimodalrag/.conda/tessera-gpt4o/bin/python}"
...
RANKINGS_DEBUG="${RANKINGS_DEBUG:-${ROOT_DIR}/artifacts/results/20260706_212912_paper_retrieval_metrics_tessera_esr_v36/rankings_debug.jsonl}"
...
for K in 4 5; do
  METHOD_LABEL="tessera_esr_v36_ctx${K}"
