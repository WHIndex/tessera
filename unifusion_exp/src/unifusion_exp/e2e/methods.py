...
METHOD_LABELS = {
    ...
    "unifusion_rag": "UniFusion-RAG (Ours)",
    "ablation_no_redundancy_e2e": "(d) UniFusion w/o Redundancy",
    "ablation_no_pathmaxsim_e2e": "(e) UniFusion w/o PathMaxSim",
    "unifusion_submod": "UniFusion-Submod (Ours)",
}
...
METHOD_MODALITY_COVERAGE = {
    ...
    "unifusion_rag": "T+Tbl+G+Vec",
    "ablation_no_redundancy_e2e": "T+Tbl+G+Vec",
    "ablation_no_pathmaxsim_e2e": "T+Tbl+G+Vec",
    "unifusion_submod": "T+Tbl+G+Vec",
}

METHOD_PRESETS = {
    "targeted": ["dense_concat", "unifusion_rag"],
    "main_only": ["dense_concat", "unifusion_rag"],
    "pathmaxsim": ["dense_concat", "unifusion_rag", "ablation_no_pathmaxsim_e2e"],
    "redundancy": ["dense_concat", "unifusion_rag", "ablation_no_redundancy_e2e"],
    "baselines": ["dense_concat", "naive_rag", "carp", "tablerag", "quasar", "unihgkr_dense"],
    "submod": ["dense_concat", "unifusion_rag", "unifusion_submod"],  # diagnostic only; submod underperforms in full eval
    "full": METHOD_KEYS,
}
