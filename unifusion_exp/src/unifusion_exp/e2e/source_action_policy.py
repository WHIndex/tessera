...
try:
    from unifusion_exp.e2e.source_budgeter import (
...
TRACE_FEATURE_KEYS = [
    ...
    "unifusion_source_budgeter_top1_prob_text",
    "unifusion_source_budgeter_top1_prob_table",
    "unifusion_source_budgeter_top1_prob_kg",
    "unifusion_source_budgeter_need_prob_text",
    "unifusion_source_budgeter_need_prob_table",
    "unifusion_source_budgeter_need_prob_kg",
    "unifusion_source_evidence_kg_guard_active",
    "unifusion_source_evidence_kg_guard_recovered",
    "unifusion_source_evidence_kg_guard_effective_min_kg",
    "unifusion_source_evidence_kg_count_after",
    "unifusion_source_head_changed",
    "unifusion_source_head_top1_changed",
]
...
def kg_sensitive_query(query_id: str, ranked_doc_ids: Sequence[str], trace: dict | None = None) -> bool:
    ...
    kg_signals = [
        ...
        _trace_value(trace, "unifusion_source_budgeter_top1_prob_kg"),
        _trace_value(trace, "unifusion_source_budgeter_need_prob_kg"),
    ]
