...
from unifusion_exp.e2e.pairwise_slot_verifier import (  # noqa: E402
    PESV_FEATURE_NAMES,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Train Evidence Replacement Verifier from train/dev UniFusion rankings_debug traces."
    )
    ...
    parser.add_argument("--run-id", default="unifusion_erv_v1")
    ...
    allow_test_training = bool(args.allow_test_split_training) or os.environ.get(
        "UNIFUSION_ALLOW_TEST_SPLIT_TRAINING", "0"
    ) == "1"
