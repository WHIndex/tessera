...
from unifusion_exp.e2e.source_action_policy import source_bucket  # noqa: E402
...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    lines: list[str] = []
    lines.append("# UniFusion Retrieval Ceiling Diagnosis")
    lines.append("")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Diagnose retrieval ceilings and error sources for UniFusion rankings.")
