...
TRACE_KEYS = [
    ...
    "unifusion_ser_mean_score",
    "unifusion_gee_expand_triggered",
    "unifusion_gee_expand_graph_added",
    "unifusion_gee_expand_output_candidates",
    "unifusion_retrieval_agent_forced_hits",
    "unifusion_retrieval_agent_coverage",
    "unifusion_ser_evidence_set_cardinality_need",
    "unifusion_ser_evidence_set_slot_coverage",
    "unifusion_ser_evidence_set_family_count",
    "unifusion_ser_evidence_set_anchor_hits",
]
