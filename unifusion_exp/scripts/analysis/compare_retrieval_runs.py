...
TRACE_KEYS = [
    "unifusion_v9_candidate_pool_any_hit",
    "unifusion_v9_candidate_pool_rel_coverage",
    "unifusion_ser_changed_count",
    "unifusion_v10_conservative_rerank",
    "unifusion_v10_changed_count",
    "unifusion_v10_restored_from_reference",
    "unifusion_v10_accepted_new",
    "unifusion_v10_rejected_new",
    "unifusion_v10_effective_margin",
    "unifusion_v10_effective_relevance_floor",
    "unifusion_v10_reference_topk_overlap_before",
    "unifusion_v10_reference_topk_overlap_after",
]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare UniFusion retrieval run directories.")
