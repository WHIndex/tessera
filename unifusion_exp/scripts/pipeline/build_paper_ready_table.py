...
def main() -> int:
    ...
    unifusion_main = load_json(Path("artifacts/results/unifusion_main_vs_baselines_dev200_v1.json"))
    ...
    table1c_sig_fp, table1c_sig = first_existing_json(
        [
            Path("artifacts/results/table1c_e2e_mmrag_main_aligned/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_mmrag_official_main_aligned/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260328_llm_qwen25_campe_full1286_all_v2_ablationfix/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260328_llm_qwen25_campe_full1286_all_v1/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260327_llm_qwen25_campe_full1286_v2_dense4/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260327_llm_qwen25_adaptivectx_v1/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260327_llm_qwen25_routerfix_p0/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260327_llm_qwen25_p0/e2e_paired_bootstrap_dense_vs_unifusion.json"),
            Path("artifacts/results/table1c_e2e_20260327/e2e_paired_bootstrap_dense_vs_unifusion.json"),
        ]
    )
    ...
    if unifusion_main and isinstance(unifusion_main.get("methods"), dict):
        for method, vals in unifusion_main["methods"].items():
            rows.extend(
                [
    ...
    if v5_adaptive_dev200 and isinstance(v5_adaptive_dev200.get("methods"), dict):
        for method in ["baseline_dense", "main_unifusion"]:
    ...
    if significance and isinstance(significance.get("rows"), list):
        ...
        main_dense_sig = pick_delta("main_unifusion - baseline_dense", "recall@20")
        main_sparse_sig = pick_delta("main_unifusion - baseline_sparse_tfidf", "recall@10")
        main_ablation_sig = pick_delta("main_unifusion - ablation_no_redundancy_detection", "recall@10")
    ...
    if table1c_sig and isinstance(table1c_sig.get("rows"), list):
        sig_meta = table1c_sig.get("meta", {}) if isinstance(table1c_sig, dict) else {}
        md.append("")
        md.append("## Table 1c Paired Bootstrap (UniFusion vs Dense)")
        md.append(
    ...
    if router_fast_fp or router_deberta_fp:
        ...
        md.append("- main_retrieval: artifacts/results/unifusion_main_vs_baselines_dev200_v1.json")
        ...
        if table1c_sig_fp:
            ...
            md.append("- table1c_e2e_sig: artifacts/results/table1c_e2e_20260328_llm_qwen25_campe_full1286_all_v1/e2e_paired_bootstrap_dense_vs_unifusion.json (missing)")
