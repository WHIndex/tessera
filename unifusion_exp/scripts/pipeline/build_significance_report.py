...
def main() -> int:
    ...
    parser.add_argument(
        "--main-detail",
        type=Path,
        default=Path("artifacts/results/unifusion_main_vs_baselines_dev200_v1_detail.json"),
    )
    parser.add_argument(
        "--out-json",
        type=Path,
    ...
    if args.main_detail.exists():
        ...
        comparisons = [
            ("main_unifusion", "baseline_dense"),
            ("main_unifusion", "baseline_sparse_tfidf"),
            ("main_unifusion", "ablation_no_late_interaction"),
            ("main_unifusion", "ablation_no_uncertainty_gating"),
            ("main_unifusion", "ablation_no_redundancy_detection"),
        ]
