#!/usr/bin/env python3
"""Error typology analysis for UniFusion-RAG vs Dense-Concat."""
import json
import sys
...
def main():
    ...
    methods = {"dense_concat": "Dense-Concat", "unifusion_rag": "UniFusion-RAG"}
    preds = {}
    ...
    for q in queries:
        ...
        by_modality[modality]["unifusion_rag"][uni_err] += 1
