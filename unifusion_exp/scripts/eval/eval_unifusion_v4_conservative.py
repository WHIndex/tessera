...
def main() -> int:
    ...
    print("=" * 60)
    print("UniFusion-RAG V4: Conservative Fusion")
    print("=" * 60)
    ...
    methods = {
        ...
        "unifusion_v4": v4_summary,
        "main_unifusion": v4_summary,
    }
    ...
    detail_out = {
        ...
        "methods": {
            ...
            "unifusion_v4": v4_detail,
            "main_unifusion": v4_detail,
        },
        "main_diagnostics": {
            "summary": {
                "avg_main_dense_overlap_at_k": float(np.mean([d["dense_overlap_ratio"] for d in main_diag])),
