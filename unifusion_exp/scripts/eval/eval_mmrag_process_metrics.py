...
from unifusion_exp.utils.e5_embed import encode_texts, load_e5  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--retrieval-detail", type=Path, required=True, help="detail json from eval_unifusion_retrieval_main.py with --save-predictions")
    parser.add_argument("--retrieval-method", type=str, default="main_unifusion", help="Key inside retrieval-detail predictions")
