...
def main() -> int:
    ...
    parser.add_argument("--label", type=str, default="UniFusion-CEPS")
        ...
        debug_rows.append(
            {
                ...
                "trace": {
                    "unifusion_ceps_active": 1.0,
                    "unifusion_ceps_selected_policy": selection.policy,
                    "unifusion_ceps_switched": float(selection.switched),
                    "unifusion_ceps_predicted_utility": float(selection.predicted_utility),
                    "unifusion_ceps_default_utility": float(selection.default_utility),
                    "unifusion_ceps_predicted_margin": float(selection.margin),
                    "unifusion_ceps_switch_margin": float(margin),
                    "unifusion_ceps_policy_scores": selection.policy_scores,
                    "unifusion_ceps_positive_probs": selection.positive_probs,
                },
            }
        )
